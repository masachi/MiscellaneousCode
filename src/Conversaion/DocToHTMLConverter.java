...
public class DocToHTMLConverter extends Converter {
    ...
    public DocToHTMLConverter(String inPath, String outPath, InputStream inStream, OutputStream outStream, boolean showMessages, boolean closeStreamsWhenComplete) {
